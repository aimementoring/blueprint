...
function parsePhoneNumberFromString$2() {
	return call(parsePhoneNumberFromString$1, arguments)
}
...
var required = function required(customMessage) {
  return function (value) {
    return !valueIsEmpty(value) && value !== false ? undefined : customMessage || 'Required';
  };
};
var requiredIf = function requiredIf(condition) {
  return function (customMessage) {
    return function (value) {
      return condition ? required(customMessage)(value) : undefined;
    };
  };
};
var validateNumeric = function validateNumeric(customMessage) {
  return function (value) {
    return !value || regularExpressions.numeric.test(value) ? undefined : customMessage || 'This value should be a valid number';
  };
};
var validateAlphanumeric = function validateAlphanumeric(customMessage) {
  return function (value) {
    return valueIsEmpty(value) || regularExpressions.alphanumeric.test(value) ? undefined : customMessage || "This value shouldn't contain special characters";
  };
};
var validateEmail = function validateEmail(customMessage) {
  return function (value) {
    return valueIsEmpty(value) || regularExpressions.email.test(value) ? undefined : customMessage || 'This value is not a valid email';
  };
};
var validateInclusionIn = function validateInclusionIn(array) {
  return function (customMessage) {
    return function (value) {
      if (!value) return undefined;
      return array.indexOf(value) !== -1 ? undefined : customMessage || "Could not find \"".concat(value, "\" in ").concat(array.join(', '));
    };
  };
};
var validateMobilePhone = function validateMobilePhone(customMessage) {
  return function (value) {
    if (valueIsEmpty(value)) return undefined;
    var phoneNumber = parsePhoneNumberFromString$2(value, 'AU');
    return phoneNumber && phoneNumber.isValid() ? undefined : customMessage || 'This value is not a valid phone number';
  };
};
var getFormattedMobilePhone = function getFormattedMobilePhone(value) {
  return valueIsEmpty(value) ? {} : parsePhoneNumberFromString$2(value, 'AU');
};
var validateNonNegative = function validateNonNegative(customMessage) {
  return function (value) {
    return value >= 0 ? undefined : customMessage || "This value shouldn't be negative";
  };
};
var validateHigherThanZero = function validateHigherThanZero(customMessage) {
  return function (value) {
    return !value && value !== 0 || value > 0 ? undefined : customMessage || 'This value should be higher than zero';
  };
};
var minAmount = index(function (min, customMessage) {
  return function (value) {
    return value && value < min ? customMessage || "This value should not be less than ".concat(min) : undefined;
  };
});
var maxAmount = index(function (max, customMessage) {
  return function (value) {
    return value && value > max ? customMessage || "This value should not be more than ".concat(max) : undefined;
  };
});
var maxCharacters = index(function (max, customMessage) {
  return function (value) {
    return value && value.length > max ? customMessage || "This value should contain maximum ".concat(max, " characters") : undefined;
  };
});
var minCharacters = index(function (min, customMessage) {
  return function (value) {
    return value && value.length < min ? customMessage || "This value should contain minimum ".concat(min, " characters") : undefined;
  };
});
var validDate = function validDate(customMessage) {
  return function (value) {
    if (!value) {
      return undefined;
    }
    ...
    return typeof value === 'string' && (valueIsEmpty(value) || !isNaN(Date.parse(value)) || moment(value, 'MM-DD-YYYY', true).isValid() || moment(value, 'MM/DD/YYYY', true).isValid() || moment(value, 'MM/DD/YY', true).isValid() || moment(value, 'MM-DD-YY', true).isValid() || moment(value, 'YYYY-MM-DD', true).isValid() || moment(value, 'YYYY-M-D', true).isValid() || moment(value, 'YYYY-MM-D', true).isValid() || moment(value, 'YYYY-M-DD', true).isValid()) ? undefined : customMessage || 'This should be a valid date (for example: YYYY-MM-DD)';
  };
};
...
var validateComponents = function validateComponents(componentsObject, props) {
  var hasError = false;

  for (var i = 0; i < Object.keys(componentsObject).length; i++) {
    var inputField = Object.keys(componentsObject)[i];
    var componentSelected = componentsObject[inputField];

    if (!(componentSelected.condition && !componentSelected.condition())) {
      var validationMessage = checkValidations(componentSelected.validations, props[inputField]);
...
exports.getFormattedMobilePhone = getFormattedMobilePhone;
...
exports.validateHigherThanZero = validateHigherThanZero;
exports.validateInclusionIn = validateInclusionIn;
exports.validateMobilePhone = validateMobilePhone;
