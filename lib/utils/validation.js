...
var validateMobilePhone = function validateMobilePhone(customMessage) {
  return function (value) {
    ...
    var phoneNumber = parsePhoneNumberFromString$2(value);
...
export { checkValidations, maxAmount, maxCharacters, minAmount, minCharacters, required, validDate, validateAlphanumeric, validateComponents, validateEmail, validateHigherThanZero, validateMobilePhone, validateNonNegative, validateNumeric };
