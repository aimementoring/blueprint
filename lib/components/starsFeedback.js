...
const Star = ({
  ...
  className: classnames(styles.star, {
    [styles.starSelected]: star <= starSelected
  }),
  onClick: () => onSelect(star),
  key: star
}, "\u2606");

class StarsFeedback extends react_3 {
  constructor(...args) {
    super(...args);

    this.handleStarSelected = starSelected => {
  ...
  render() {
    ...
    }, starsList.map(star => react.createElement(Star, {
