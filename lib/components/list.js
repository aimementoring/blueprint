...
class List extends react_3 {
  render() {
    ...
    const _listTypeClass$type = listTypeClass[type],
          style = _listTypeClass$type.style,
          Component = _listTypeClass$type.tag;
    const listElements = children ? react.Children.toArray(children) : list || [text];
    return react.createElement("div", {
      className: classnames(styles["theme-".concat(theme)], containerClassName)
    }, react.createElement(Component, {
      className: classnames(style, className)
    }, listElements && listElements.map((item, index) => react.createElement("li", {
...
List.defaultProps = _objectSpread2({}, defaultComponentPropTypes, {
  type: 'ulList'
});
