...
var cloneElement = function (a, b, c) {
  if (null === a || void 0 === a) throw Error(C(267, a)); var e = objectAssign({}, a.props), d = a.key, g = a.ref, k = a._owner; if (null != b) { void 0 !== b.ref && (g = b.ref, k = J.current); void 0 !== b.key && (d = "" + b.key); if (a.type && a.type.defaultProps) var f = a.type.defaultProps; for (h in b) K.call(b, h) && !L.hasOwnProperty(h) && (e[h] = void 0 === b[h] && void 0 !== f ? f[h] : b[h]); } var h = arguments.length - 2; if (1 === h) e.children = c; else if (1 < h) { f = Array(h); for (var m = 0; m < h; m++)f[m] = arguments[m + 2]; e.children = f; } return {
    $$typeof: p, type: a.type,
    key: d, ref: g, props: e, _owner: k
  }
}; var createContext = function (a, b) { void 0 === b && (b = null); a = { $$typeof: w, _calculateChangedBits: b, _currentValue: a, _currentValue2: a, _threadCount: 0, Provider: null, Consumer: null }; a.Provider = { $$typeof: v, _context: a }; return a.Consumer = a }; var createElement = M; var createFactory = function (a) { var b = M.bind(null, a); b.type = a; return b }; var createRef = function () { return { current: null } }; var forwardRef = function (a) { return { $$typeof: x, render: a } }; var isValidElement = O;
...
var css_248z = ".list-module_ulList__3_9JY,\n.list-module_olList__3fy1u {\n  font-size: 1rem;\n  line-height: 1.3;\n  margin-bottom: 1rem;\n  list-style: disc outside none; }\n  .list-module_theme-base__3b553 .list-module_ulList__3_9JY, .list-module_theme-base__3b553\n  .list-module_olList__3fy1u {\n    font-family: \"GT Pressura Mono\", \"Univers Light\", \"Helvetica Neue\", Helvetica, Arial, sans-serif; }\n  .list-module_theme-storm__1YbRj .list-module_ulList__3_9JY, .list-module_theme-storm__1YbRj\n  .list-module_olList__3fy1u {\n    font-family: \"GT Pressura Mono\", \"Univers Light\", \"Helvetica Neue\", Helvetica, Arial, sans-serif; }\n  .list-module_theme-plain__1_axu .list-module_ulList__3_9JY, .list-module_theme-plain__1_axu\n  .list-module_olList__3fy1u {\n    font-family: \"GT Pressura Mono\", \"Univers Light\", \"Helvetica Neue\", Helvetica, Arial, sans-serif; }\n  .list-module_theme-rainbow__G3ZI6 .list-module_ulList__3_9JY, .list-module_theme-rainbow__G3ZI6\n  .list-module_olList__3fy1u {\n    font-family: \"GT Pressura Mono\", \"Univers Light\", \"Helvetica Neue\", Helvetica, Arial, sans-serif; }\n  .list-module_ulList__3_9JY li,\n  .list-module_olList__3fy1u li {\n    list-style: inherit;\n    margin-left: 2em; }\n\n.list-module_olList__3fy1u {\n  list-style: decimal outside none; }\n";
var styles = { "ulList": "list-module_ulList__3_9JY", "olList": "list-module_olList__3fy1u", "theme-base": "list-module_theme-base__3b553", "theme-storm": "list-module_theme-storm__1YbRj", "theme-plain": "list-module_theme-plain__1_axu", "theme-rainbow": "list-module_theme-rainbow__G3ZI6" };
...
class List extends react_3 {
  render() {
    ...
    var _listTypeClass$type = listTypeClass[type],
      style = _listTypeClass$type.style,
      Component = _listTypeClass$type.tag;
    var listElements = children ? react.Children.toArray(children) : list || [text];
    return react.createElement("div", {
      className: classnames(styles["theme-".concat(theme)], containerClassName)
    }, react.createElement(Component, {
      className: classnames(style, className)
    }, listElements && listElements.map(function (item, index) {
...
List.defaultProps = _objectSpread({}, defaultComponentPropTypes, {
  type: 'ulList'
});
