...
var CountdownTimer = function CountdownTimer(_ref) {
  ...
  react_8(function () {
    interval = setInterval(function () {
      var updatedDate = calculateCountdown(date);
  ...
  var calculateCountdown = function calculateCountdown(endDate) {
    ...
    var diff = (momentTimezone$1.tz(endDate, 'America/New_York') - momentTimezone$1().tz('America/New_York')) / 1000; // clear countdown when date is reached
