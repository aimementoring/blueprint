...
var calculateCountdown = function calculateCountdown(endDate) {
  var startDate = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : new Date().toISOString();
  var diff = (momentTimezone$1.tz(endDate, 'America/New_York') - momentTimezone$1.tz(startDate, 'America/New_York')) / 1000; // clear countdown when date is reached
  ...
  diff %= MINUTE;
  var seconds = Number(diff.toFixed(0));
...
var css = ".countdownTimer-module_countDownContainerFeatureBoard__1zlrh {\n  margin-top: 1rem;\n  padding-top: 1rem; }\n  .countdownTimer-module_countDownContainerFeatureBoard__1zlrh .countdownTimer-module_countdownColElement__1nas- {\n    display: flex;\n    flex-direction: column;\n    margin: 0 10px; }\n    @media screen and (max-width: 52em) {\n      .countdownTimer-module_countDownContainerFeatureBoard__1zlrh .countdownTimer-module_countdownColElement__1nas- {\n        margin: 0 3px; } }\n  .countdownTimer-module_countDownContainerFeatureBoard__1zlrh .countdownTimer-module_countdownCol__3knnM {\n    display: inline-block; }\n  .countdownTimer-module_countDownContainerFeatureBoard__1zlrh .countdownTimer-module_countdown__2Oeqs {\n    flex-direction: row;\n    display: flex;\n    justify-content: center; }\n  .countdownTimer-module_countDownContainerFeatureBoard__1zlrh .countdownTimer-module_countdownNumber__3sYUn {\n    font-family: \"Poppins\", Helvetica, Arial, sans-serif;\n    font-weight: 900;\n    font-style: normal;\n    font-size: 2.5rem;\n    color: #3e4345;\n    background: #ffffff;\n    padding: 0.5em 0;\n    text-align: center;\n    border-radius: 0.5em;\n    width: 4em; }\n    @media screen and (max-width: 52em) {\n      .countdownTimer-module_countDownContainerFeatureBoard__1zlrh .countdownTimer-module_countdownNumber__3sYUn {\n        font-size: 1.5rem;\n        width: 3em; } }\n  .countdownTimer-module_countDownContainerFeatureBoard__1zlrh .countdownTimer-module_countdownLabel__2mKkM {\n    font-family: \"Poppins\", Helvetica, Arial, sans-serif;\n    font-weight: 900;\n    font-style: italic;\n    text-transform: uppercase;\n    font-size: 1.2rem;\n    text-align: center;\n    margin-top: 10px; }\n    @media screen and (max-width: 52em) {\n      .countdownTimer-module_countDownContainerFeatureBoard__1zlrh .countdownTimer-module_countdownLabel__2mKkM {\n        font-size: 1rem; } }\n";
var styles = {"countDownContainerFeatureBoard":"countdownTimer-module_countDownContainerFeatureBoard__1zlrh","countdownColElement":"countdownTimer-module_countdownColElement__1nas-","countdownCol":"countdownTimer-module_countdownCol__3knnM","countdown":"countdownTimer-module_countdown__2Oeqs","countdownNumber":"countdownTimer-module_countdownNumber__3sYUn","countdownLabel":"countdownTimer-module_countdownLabel__2mKkM"};
styleInject(css);
...
var timeNames = ['Year', 'Day', 'Hour', 'Min', 'Sec'];
...
var TimeColumn = function TimeColumn(_ref) {
  ...
  return react.createElement("span", {
    ...
    className: styles.countdownColElement
  }, react.createElement("span", {
    className: styles.countdownNumber
  }, addLeadingZeros(time)), react.createElement("span", {
    className: styles.countdownLabel
  }, "".concat(timeNames[index]).concat(time === 1 ? '' : 's'))));
};

var columnsIndex = ['year', 'day', 'hour', 'month', 'second'];

var CountdownTimer = function CountdownTimer(_ref) {
  var theme = _ref.theme,
      date = _ref.date;

  var _useState = react_7([0, 0, 0, 0, 0]),
  ...
  react_8(function () {
    interval = setInterval(function () {
      var updatedDate = calculateCountdown(date, new Date().toISOString());
      if (Math.max.apply(Math, _toConsumableArray(updatedDate)) === 0) stop();
  ...
  return react.createElement("div", {
    ...
    className: styles.countDownContainerFeatureBoard
  }, react.createElement("div", {
    className: styles.countdown
  }, countDown.map(function (time, index) {
    return react.createElement(TimeColumn, {
      time: time,
...
CountdownTimer.defaultProps = _objectSpread({}, defaultComponentPropTypes, {
