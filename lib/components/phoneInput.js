		...
		_createClass(InputSmart, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(inputFormat.ReactInput, _extends({}, rest, {
					ref: this.storeInput,
					parse: core.parsePhoneNumberCharacter,
					format: this.format }));
			}
		}]);
	...
	if (new_country) {
		...
		if (value[0] === '+') {
			...
			if (preferNationalFormat) {
				...
				if (value.indexOf('+' + (0, core.getCountryCallingCode)(new_country, metadata)) === 0) {
...
Object.defineProperty(exports, 'parseRFC3966', {
  enumerable: true,
  get: function get() {
    return core.parseRFC3966;
  }
});
Object.defineProperty(exports, 'formatRFC3966', {
  enumerable: true,
  get: function get() {
    return core.formatRFC3966;
  }
});
...
var parsePhoneNumber$2 = createCommonjsModule(function (module, exports) {
...
Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function get() {
    return core.parsePhoneNumberFromString;
  }
});

});

unwrapExports(parsePhoneNumber$2);
...
var _parsePhoneNumber2 = _interopRequireDefault(parsePhoneNumber$2);
...
var parsePhoneNumber$3 = unwrapExports(parsePhoneNumberDefaultMetadata);
...
function formatPhoneNumber(value, format, metadata) {
	...
	var phoneNumber = (0, core.parsePhoneNumberFromString)(value, metadata);
	if (!phoneNumber) {
		return '';
	}
	// Deprecated.
...
var getCountries = createCommonjsModule(function (module, exports) {
...
exports.default = getCountries$1;



var _getCountries2 = _interopRequireDefault(getCountries);
...
function (_PureComponent) {
  ...
  function PhoneInput() {
    ...
    _this.handleChange = function (value) {
      ...
      if (value) {
        parsedValue = parsePhoneNumber$3(value);
      }
