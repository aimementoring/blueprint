...
function parseNationalNumber(number, metadata) {
	...
	if (metadata.possibleLengths()) {
		...
		// like `8` is the national prefix for Russia and both
		// `8 800 555 35 35` and `800 555 35 35` are valid numbers.
		if (matchesEntirely(nationalNumber, metadata.nationalNumberPattern()) && !matchesEntirely(potentialNationalNumber, metadata.nationalNumberPattern())) ; else {
			nationalNumber = potentialNationalNumber;
			carrierCode = potentialCarrierCode;
		}
	}
...
function withValidation(WrappedComponent) {
  ...
  function (_React$Component) {
    ...
    function _class(props) {
      ...
      _this.isValidationOk = function () {
        return !!_this.state.validationMessage;
      };

      _this.renderValidationError = function () {
        return _this.isValidationOk() && react.createElement("span", {
...
function (_PureComponent) {
  ...
  function PhoneInput() {
    ...
    _this.handleChange = function (value) {
      ...
      if (value) {
        parsedValue = parsePhoneNumber$4(value);
      }
...
PhoneInput$1.defaultProps = _objectSpread2({}, defaultComponentPropTypes, {
  ...
  onChangeFunction: function onChangeFunction() {} // http://catamphetamine.github.io/react-phone-number-input/docs/styleguide/index.html#phoneinput
