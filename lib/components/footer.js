...
var css_248z = ".footer-module_footerBackground__MOljU {\n  background-color: #0b0b0b; }\n\n.footer-module_outerLinksContainer__2yraC {\n  padding-top: 4rem;\n  max-width: 100%;\n  position: relative; }\n  @media screen and (min-width: 64em) {\n    .footer-module_outerLinksContainer__2yraC {\n      padding-bottom: 4rem; } }\n\n.footer-module_innerLinksContainer__2HtW0 {\n  display: flex;\n  margin: 0 auto;\n  max-width: 1120px;\n  overflow: visible;\n  padding: 0 2rem; }\n\n.footer-module_fullWidth__2H4_4 {\n  width: 100%;\n  flex-direction: row;\n  justify-content: space-between;\n  display: flex; }\n\n.footer-module_flex___CuDi {\n  flex: 1 1 auto;\n  min-width: 0;\n  min-height: 0;\n  display: flex; }\n  .footer-module_flex___CuDi.footer-module_wrap__1kWGd {\n    flex-wrap: wrap; }\n\n@media screen and (min-width: 64em) {\n  .footer-module_rightContainer__22NdT {\n    justify-content: flex-end; } }\n\n@media screen and (max-width: 64em) {\n  .footer-module_rightContainer__22NdT {\n    justify-content: flex-start; } }\n\n.footer-module_becomeFriend__1f9eY {\n  flex-direction: column;\n  display: flex;\n  width: 100%;\n  max-width: 350px; }\n\n.footer-module_formContainer__rQpK8 {\n  margin-bottom: 2rem;\n  flex-direction: column; }\n\n.footer-module_informativeParagraph__6YvIG {\n  color: #ffffff;\n  font-size: 14px;\n  padding-bottom: 1rem; }\n\n.footer-module_emailInput__2L1_5 {\n  color: #410048c4;\n  height: 60px;\n  background-color: #fef6ff;\n  border: 1px solid #550d94;\n  font-weight: 400;\n  font-size: 16px;\n  font-family: \"Poppins\", Helvetica, Arial, sans-serif;\n  border-radius: 6px;\n  padding: 1rem;\n  vertical-align: middle;\n  outline: none;\n  box-sizing: border-box;\n  appearance: none;\n  width: 100%; }\n  .footer-module_emailInput__2L1_5::placeholder {\n    color: #410048c4; }\n\n.footer-module_submitEmail__2j8I9 {\n  position: absolute;\n  top: 0;\n  right: 0;\n  height: 100%;\n  font-size: 16px;\n  margin: 0;\n  padding: 0 2rem;\n  border: 1px solid #7603db;\n  background: #7603db;\n  background-image: url(\"https://d2ylaz7bdw65jx.cloudfront.net/assets/images/arrow.svg\");\n  background-repeat: no-repeat;\n  background-size: 20px;\n  background-position: 50%;\n  border-top-right-radius: 6px;\n  border-bottom-right-radius: 6px;\n  display: -ms-flexbox;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  cursor: pointer;\n  text-align: center; }\n\n.footer-module_relative__4u-7l {\n  position: relative; }\n\n.footer-module_navColumn__1VgTk {\n  flex: 1 1 auto;\n  min-width: 0;\n  min-height: 0;\n  margin-bottom: 2rem;\n  display: block; }\n  @media screen and (min-width: 40em) {\n    .footer-module_navColumn__1VgTk {\n      width: unset; } }\n\n.footer-module_navTitle__1P_FU {\n  color: #ffffff;\n  font-weight: 500;\n  font-size: 15px;\n  padding-bottom: 1rem; }\n  .footer-module_theme-base__3gsL9 .footer-module_navTitle__1P_FU {\n    font-family: \"Luna Emu\", \"Poppins Black\", \"Arial Black\", \"sans serif\"; }\n  .footer-module_theme-storm__VD6Ka .footer-module_navTitle__1P_FU {\n    font-family: \"Luna Emu\", \"Poppins Black\", \"Arial Black\", \"sans serif\"; }\n  .footer-module_theme-plain__KNZOz .footer-module_navTitle__1P_FU {\n    font-family: \"Luna Emu\", \"Poppins Black\", \"Arial Black\", \"sans serif\"; }\n  .footer-module_theme-rainbow__2IH6V .footer-module_navTitle__1P_FU {\n    font-family: \"Luna Emu\", \"Poppins Black\", \"Arial Black\", \"sans serif\"; }\n\n.footer-module_link__2nO3B {\n  color: #ffffff;\n  text-decoration: none;\n  font-weight: 700;\n  letter-spacing: 0.001em;\n  opacity: 1;\n  transition: opacity 0.1s ease-in; }\n  .footer-module_link__2nO3B:hover {\n    color: #c700ff; }\n\n.footer-module_navList__N27jr {\n  font-size: 14px;\n  list-style: none;\n  padding-left: 0; }\n  .footer-module_navList__N27jr .footer-module_navItem__1pOVB {\n    margin-bottom: 1rem; }\n\n@media screen and (min-width: 64em) {\n  .footer-module_copyrightContainer__1UooN {\n    padding: 0.5rem 2rem; } }\n\n.footer-module_copyrightContainer__1UooN .footer-module_maxWidthContainer__1cs2J {\n  font-size: 12px;\n  max-width: 1300px;\n  margin: 0 auto;\n  justify-content: space-between;\n  flex-direction: column;\n  display: flex;\n  padding-top: 0.5rem; }\n  @media screen and (min-width: 64em) {\n    .footer-module_copyrightContainer__1UooN .footer-module_maxWidthContainer__1cs2J {\n      flex-direction: row;\n      padding: 0;\n      padding-top: 0; } }\n\n.footer-module_copyrightContainer__1UooN .footer-module_footerText__3kOmr, .footer-module_copyrightContainer__1UooN .footer-module_footerLinksList__FxIiW .footer-module_footerLink__1vlZX {\n  margin-top: 0.5rem;\n  margin-bottom: 0.5rem;\n  font-weight: 400;\n  text-decoration: none;\n  color: #ffffff;\n  transition: color 0.2s ease-in; }\n  .footer-module_theme-base__3gsL9 .footer-module_copyrightContainer__1UooN .footer-module_footerText__3kOmr, .footer-module_theme-base__3gsL9 .footer-module_copyrightContainer__1UooN .footer-module_footerLinksList__FxIiW .footer-module_footerLink__1vlZX {\n    font-family: \"Luna Emu\", \"Poppins Black\", \"Arial Black\", \"sans serif\"; }\n  .footer-module_theme-storm__VD6Ka .footer-module_copyrightContainer__1UooN .footer-module_footerText__3kOmr, .footer-module_theme-storm__VD6Ka .footer-module_copyrightContainer__1UooN .footer-module_footerLinksList__FxIiW .footer-module_footerLink__1vlZX {\n    font-family: \"Luna Emu\", \"Poppins Black\", \"Arial Black\", \"sans serif\"; }\n  .footer-module_theme-plain__KNZOz .footer-module_copyrightContainer__1UooN .footer-module_footerText__3kOmr, .footer-module_theme-plain__KNZOz .footer-module_copyrightContainer__1UooN .footer-module_footerLinksList__FxIiW .footer-module_footerLink__1vlZX {\n    font-family: \"Luna Emu\", \"Poppins Black\", \"Arial Black\", \"sans serif\"; }\n  .footer-module_theme-rainbow__2IH6V .footer-module_copyrightContainer__1UooN .footer-module_footerText__3kOmr, .footer-module_theme-rainbow__2IH6V .footer-module_copyrightContainer__1UooN .footer-module_footerLinksList__FxIiW .footer-module_footerLink__1vlZX {\n    font-family: \"Luna Emu\", \"Poppins Black\", \"Arial Black\", \"sans serif\"; }\n\n.footer-module_copyrightContainer__1UooN .footer-module_footerLinksList__FxIiW {\n  display: flex;\n  flex-direction: column;\n  list-style: none;\n  padding-left: 0;\n  margin: 0;\n  padding: 0; }\n  @media screen and (min-width: 64em) {\n    .footer-module_copyrightContainer__1UooN .footer-module_footerLinksList__FxIiW {\n      flex-direction: row; } }\n  .footer-module_copyrightContainer__1UooN .footer-module_footerLinksList__FxIiW .footer-module_footerLink__1vlZX {\n    margin-right: 2rem;\n    display: flex; }\n    .footer-module_copyrightContainer__1UooN .footer-module_footerLinksList__FxIiW .footer-module_footerLink__1vlZX:last-child {\n      margin-right: 0; }\n";
var styles = {"footerBackground":"footer-module_footerBackground__MOljU","outerLinksContainer":"footer-module_outerLinksContainer__2yraC","innerLinksContainer":"footer-module_innerLinksContainer__2HtW0","fullWidth":"footer-module_fullWidth__2H4_4","flex":"footer-module_flex___CuDi","wrap":"footer-module_wrap__1kWGd","rightContainer":"footer-module_rightContainer__22NdT","becomeFriend":"footer-module_becomeFriend__1f9eY","formContainer":"footer-module_formContainer__rQpK8","informativeParagraph":"footer-module_informativeParagraph__6YvIG","emailInput":"footer-module_emailInput__2L1_5","submitEmail":"footer-module_submitEmail__2j8I9","relative":"footer-module_relative__4u-7l","navColumn":"footer-module_navColumn__1VgTk","navTitle":"footer-module_navTitle__1P_FU","theme-base":"footer-module_theme-base__3gsL9","theme-storm":"footer-module_theme-storm__VD6Ka","theme-plain":"footer-module_theme-plain__KNZOz","theme-rainbow":"footer-module_theme-rainbow__2IH6V","link":"footer-module_link__2nO3B","navList":"footer-module_navList__N27jr","navItem":"footer-module_navItem__1pOVB","copyrightContainer":"footer-module_copyrightContainer__1UooN","maxWidthContainer":"footer-module_maxWidthContainer__1cs2J","footerText":"footer-module_footerText__3kOmr","footerLinksList":"footer-module_footerLinksList__FxIiW","footerLink":"footer-module_footerLink__1vlZX"};
...
const Footer = ({
...
}, !location.pathname.indexOf('/seatontheplane') > -1 && react.createElement("footer", {
  className: styles.footerBackground,
  role: "contentinfo"
}, react.createElement("div", {
  className: styles.outerLinksContainer
}, react.createElement("div", {
  className: styles.innerLinksContainer
}, react.createElement("div", {
  className: styles.fullWidth
}, react.createElement("div", {
  className: "".concat(styles.flex, " ").concat(styles.wrap)
}, menuItems.map(columnMenu => react.createElement("nav", {
  className: columnMenu.className || styles.navColumn,
  key: columnMenu.title
}, react.createElement("h4", {
  className: columnMenu.titleClassName || styles.navTitle
}, columnMenu.title), react.createElement("ul", {
  className: columnMenu.listClassName || styles.navList
}, columnMenu.menu.map(item => react.createElement("li", {
  ...
  className: "".concat(styles.flex, " ").concat(styles.rightContainer)
}, react.createElement("div", {
  className: "".concat(styles.becomeFriend)
}, react.createElement("div", {
  className: "".concat(styles.flex, " ").concat(styles.formContainer)
}, react.createElement("h4", {
  className: styles.navTitle
}, "Become an AIME friend"), react.createElement("p", {
  className: styles.informativeParagraph
}, "Subscribe to our newsletter"), react.createElement("form", {
  acceptCharset: "UTF-8",
...
}, "".concat(currentYear, " \xA9 AIME")), react.createElement("div", null, react.createElement("ul", {
  className: copyright.className || styles.footerLinksList
}, copyright.items && copyright.items.map(item => react.createElement("li", {
  className: item.className || styles.footerLink,
  key: item.title
...
Footer.defaultProps = _objectSpread2({}, defaultComponentPropTypes, {
  copyright: {
    item: []
  }
});
