...
function (_Component) {
  ...
  function Facebook() {
    ...
    _defineProperty(_assertThisInitialized(_this), "playerID", PLAYER_ID_PREFIX + (0, utils.randomString)());
...
VideoPlayer.defaultProps = _objectSpread2({}, defaultComponentPropTypes, {}, videoPlayerDefaultProps);
