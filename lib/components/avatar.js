...
var css = ".avatar-module_profileAvatar__1WtSl {\n  width: 48px;\n  height: 48px;\n  line-height: 48px;\n  border-radius: 24px;\n  position: relative;\n  white-space: nowrap;\n  text-align: center;\n  display: inline-block;\n  padding: 0;\n  margin: 0;\n  vertical-align: middle;\n  color: #ffffff;\n  box-sizing: border-box;\n  list-style: none;\n  font-size: 16px;\n  overflow: hidden; }\n  .avatar-module_theme-base__1y9RH .avatar-module_profileAvatar__1WtSl {\n    background: #c6cacc;\n    font-family: \"Poppins Bold Italic\", Helvetica, Arial, sans-serif; }\n  .avatar-module_theme-purple__2lGEG .avatar-module_profileAvatar__1WtSl {\n    background: #a3a3a3;\n    font-family: \"Poppins Bold Italic\", Helvetica, Arial, sans-serif; }\n  .avatar-module_theme-light__1H1Nb .avatar-module_profileAvatar__1WtSl {\n    background: #a3a3a3;\n    font-family: \"Poppins Bold Italic\", Helvetica, Arial, sans-serif; }\n  .avatar-module_theme-portal__xyMcS .avatar-module_profileAvatar__1WtSl {\n    background: #a3a3a3;\n    font-family: \"Poppins Bold Italic\", Helvetica, Arial, sans-serif; }\n  .avatar-module_theme-website__pFuve .avatar-module_profileAvatar__1WtSl {\n    background: #a3a3a3;\n    font-family: \"Poppins Bold Italic\", Helvetica, Arial, sans-serif; }\n  .avatar-module_profileAvatar__1WtSl > img {\n    width: 100%;\n    height: 100%;\n    display: block;\n    line-height: 48px;\n    border-style: none; }\n";
var styles = {"profileAvatar":"avatar-module_profileAvatar__1WtSl","theme-base":"avatar-module_theme-base__1y9RH","theme-purple":"avatar-module_theme-purple__2lGEG","theme-light":"avatar-module_theme-light__1H1Nb","theme-portal":"avatar-module_theme-portal__xyMcS","theme-website":"avatar-module_theme-website__pFuve"};
styleInject(css);
...
function (_PureComponent) {
  ...
  _createClass(Avatar, [{
    ...
    value: function getInitials(name) {
      var names = name.trim().split('(')[0].split(' ');
      return (names.length > 1 ? "".concat(names[0][0]).concat(names.slice(-1)[0][0]) : "".concat(names[0][0]).concat(names[0][1])).toUpperCase();
    }
  }, {
    key: "render",
    value: function render() {
      ...
      }, photo && photo.length && photo[0].url ? react.createElement("img", {
        alt: text,
        src: photo[0].url
      }) : react.createElement("span", null, this.getInitials(text))));
    }
  }]);
...
Avatar.defaultProps = _objectSpread({}, defaultComponentPropTypes, {
  photo: null
});
