...
var handleInputChange = function handleInputChange(event, name, handleValidations, onChangeFunction) {
  ...
  console.log({
    isWrongValidation: isWrongValidation
  });
...
var Input = function Input(_ref) {
  var theme = _ref.theme,
      ...
      inputProps = _objectWithoutProperties(_ref, ["theme", "name", "value", "label", "className", "type", "onChangeFunction", "helperText", "containerClassName", "placeholder", "disabled", "autoFocus", "renderValidationError", "validationMessage", "handleValidations", "isValidationOk"]);
