...
var getFlexStylesFromProps = function getFlexStylesFromProps(props) {
  var justifyContent = props.justifyContent,
      alignItems = props.alignItems,
      grow = props.grow;
  var flexGrow = grow && !isNaN(grow) ? grow : grow ? 1 : undefined;

  var styles = _objectSpread({}, props.style);
...
var css = ".section-module_section__2Jwfb {\n  background-color: #ffffff;\n  border-radius: 2px;\n  padding: 1em 0.5em;\n  display: flex; }\n\n.section-module_sectionRow__26Jhv {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: space-between; }\n\n.section-module_sectionStack__1K9fL {\n  display: flex;\n  flex-direction: column;\n  align-items: stretch;\n  justify-content: space-between; }\n";
var styles = {"section":"section-module_section__2Jwfb","sectionRow":"section-module_sectionRow__26Jhv","sectionStack":"section-module_sectionStack__1K9fL"};
styleInject(css);

var SectionRow = function SectionRow(_ref) {
  var children = _ref.children,
      className = _ref.className,
      props = _objectWithoutProperties(_ref, ["children", "className"]);

  return react.createElement("div", Object.assign({}, props, {
    className: "".concat(styles.sectionRow, " ").concat(className),
    style: getFlexStylesFromProps(props)
  }), children);
};

var SectionStack = function SectionStack(_ref) {
  var children = _ref.children,
      className = _ref.className,
      props = _objectWithoutProperties(_ref, ["children", "className"]);

  return react.createElement("div", Object.assign({}, props, {
    className: "".concat(styles.sectionStack, " ").concat(className),
    style: getFlexStylesFromProps(props)
  }), children);
};
...
var Separator = function Separator(_ref) {
  ...
  return react.createElement("div", {
    style: {
      borderBottom: "".concat(width, "px ").concat(style, " ").concat(color)
    }
  });
};
...
var Section = function Section(_ref) {
  ...
  return react.createElement("div", {
    className: "".concat(styles.section, " ").concat(className),
    style: getFlexStylesFromProps(props)
  }, children);
};
