...
const ProgressBar = ({
  ...
  return react.createElement("div", {
    ...
    style: progressStyle
  }, displayNumber && "".concat(Math.min(progress, 100), "%"))));
};

ProgressBar.defaultProps = _objectSpread2({}, defaultComponentPropTypes, {
  progress: 0,
  displayNumber: false,
