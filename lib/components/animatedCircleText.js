...
class Title extends react_3 {
  render() {
    ...
    const _ref = titleTypeClass[type] || {
      classes: style,
      tag: 'span'
    },
          style = _ref.style,
    ...
    const capitalise = ([firstChar, ...rest]) => "".concat(firstChar.toLocaleUpperCase()).concat(rest.join(''));
...
const AnimatedCircleText = ({
  ...
  return react.createElement("div", {
    ...
    type: "h3Title"
  }, chars.map((char, index) => react.createElement("span", {
    style: {
