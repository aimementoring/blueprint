...
function (_PureComponent) {
  ...
  _createClass(Checkbox, [{
    ...
    value: function render() {
      ...
      }, renderValidationError(), react.createElement("input", {
        type: "hidden",
        name: name,
        value: "no"
