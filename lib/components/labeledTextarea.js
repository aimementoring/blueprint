...
var type_of = function type_of(_) {
	return typeof _ === 'undefined' ? 'undefined' : _typeof$1(_);
};
...
var checkValidations = function checkValidations(validations, value) {
...
function withValidation(WrappedComponent) {
  ...
  function (_React$Component) {
    ...
    function _class(props) {
      ...
      _this.handleValidations = function (value) {
        var validations = _this.props.validations;
        var validationResultMsg = checkValidations(validations, value);

        _this.setState({
          validationMessage: validationResultMsg || _this.props.validationMessage || '',
          value: value
        });

        return validationResultMsg || _this.props.validationMessage;
      };
      ...
      _this.hasValidationError = function () {
        return !!_this.state.validationMessage;
      };

      _this.renderValidationError = function () {
        var customStyle = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
        return _this.hasValidationError() && react.createElement("span", {
          className: classnames(styles["theme-".concat(_this.props.theme)], customStyle)
        }, react.createElement("span", {
          className: styles.errorMessage
        }, _this.getValidationMessage()));
      };
...
var Textarea = function Textarea(_ref) {
  ...
  var handleChange = function handleChange(event) {
    return handleInputChange(event, name, handleValidations, onChangeFunction);
  };
  ...
  return react.createElement("div", {
    ...
    className: classnames(className, styles$1.input, styles$1.textarea, _defineProperty({}, styles$1.error, hasValidationError())),
    id: name,
    name: name,
...
Textarea.defaultProps = _objectSpread({}, defaultComponentPropTypes, {
  ...
  disabled: false,
  readOnly: false,
  handleValidations: function handleValidations() {
    return true;
  },
