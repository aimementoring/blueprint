...
function (_Component) {
  ...
  function App() {
    ...
    _this.handleInputChange = function (attribute, event) {
      var target = event.target;
      var value = target.type === 'checkbox' ? target.checked : target.value;

      _this.updateState(attribute, target.name, value);
    };

    _this.updateState = function (mainAttribute, attribute, value) {
      var originalValue = _this.state[mainAttribute];

      _this.setState(_defineProperty({}, mainAttribute, _objectSpread({}, originalValue, _defineProperty({}, attribute, value))));
    };

    _this.renderInputComponent = function () {
      var input = _this.state.input;
      return react.createElement("div", null, react.createElement("h1", null, "Input component"), react.createElement("h4", null, "Attributes:"), react.createElement("div", null, "placeholder:", react.createElement("input", {
        type: "text",
        value: input.placeholder,
        onChange: function onChange(e) {
          return _this.handleInputChange('input', e);
        },
        name: "placeholder"
      }), react.createElement("br", null), "type:", react.createElement("input", {
        type: "text",
        value: input.type,
        onChange: function onChange(e) {
          return _this.handleInputChange('input', e);
        ...
        name: "type"
      }), react.createElement("br", null), "required:", react.createElement("input", {
        type: "checkbox",
        ...
        name: "required"
      }), react.createElement("br", null), "disabled:", react.createElement("input", {
        type: "checkbox",
        ...
        name: "disabled"
      }), react.createElement("br", null), "value: ", input.value, react.createElement("br", null)), react.createElement(Input, Object.assign({}, input, {
        name: "value",
        onChangeFunction: function onChangeFunction(attr, value) {
          return _this.updateState('input', attr, value);
        }
      })));
    };

    _this.renderButtonComponent = function () {
      return react.createElement("div", null, react.createElement("h1", null, "Button component"), react.createElement(Button, {
        type: "button",
        onClickFunction: function onClickFunction() {},
        text: "Back"
      }));
    ...
    _this.renderCheckboxComponent = function () {
      var checkbox = _this.state.checkbox;
      return react.createElement("div", null, react.createElement("h1", null, "Checkbox component"), react.createElement(Checkbox, {
        elementClassName: "classname",
        handleFieldChange: function handleFieldChange(name, value) {
          return _this.updateState(name, 'value', value);
        },
  ...
  _createClass(App, [{
    key: "render",
    value: function render() {
      return react.createElement("div", null, this.renderInputComponent(), this.renderButtonComponent(), this.renderCheckboxComponent());
    }
  }]);
...
reactDom_1(react.createElement(App, null), container);
