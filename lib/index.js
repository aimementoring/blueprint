...
var css$3 = ".textbox-module_inputWrapper__3-bZK {\n  float: left;\n  width: 100%;\n  margin-bottom: 10px; }\n\n.textbox-module_input__1Ys75 {\n  height: 60px;\n  color: #7603db;\n  background-color: #fef6ff;\n  border: 1px solid #550d94;\n  font-weight: 400;\n  font-size: 0.9rem;\n  font-family: \"Poppins Bold Italic\", Helvetica, Arial, sans-serif;\n  border-radius: 6px;\n  padding: 0.1em 1.3em;\n  box-sizing: border-box;\n  width: 100%; }\n  .textbox-module_input__1Ys75::placeholder {\n    color: rgba(65, 0, 72, 0.769); }\n  @media only screen and (max-width: 40em) {\n    .textbox-module_input__1Ys75 {\n      margin-bottom: 0.8em; } }\n\n.textbox-module_input__1Ys75:focus {\n  background-color: white;\n  border-color: #7603db;\n  outline: none; }\n\n::placeholder {\n  color: #9da1b4; }\n\n.textbox-module_textarea__3250a {\n  padding: 1rem;\n  margin: 0px;\n  height: 259px;\n  width: 784px; }\n";
var styles$3 = {"inputWrapper":"textbox-module_inputWrapper__3-bZK","input":"textbox-module_input__1Ys75","textarea":"textbox-module_textarea__3250a"};
styleInject(css$3);
  ...
  _createClass(TextBox, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          value = _this$props.value;
      return react.createElement("div", {
        className: "".concat(styles$3.inputWrapper, " ").concat(containerElementClassName)
      }, react.createElement("textarea", {
        className: "".concat(styles$3.input, " ").concat(styles$3.textarea, " ").concat(className),
        placeholder: placeholder,
